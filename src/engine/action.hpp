...
inline void Action::ordena_soldat(int id, int x, int y) { ordres1[id] = Posicio(x, y); }

inline void Action::ordena_helicopter(int id, int instruccio) { ordres2[id] = instruccio; }

inline void Action::ordena_paracaigudista(int x, int y) { ordres3.push_back(Posicio(x, y)); }
